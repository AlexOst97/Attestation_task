...
class Contacts(models.Model):
    ...
    house_number = models.CharField(
        max_length=25, blank=True, null=True, verbose_name="Номер дома"
    )
...
class Network(models.Model):
    ...
    type = models.IntegerField(
        max_length=50, choices=STATUS_CHOICES, verbose_name="Тип сети"
    )
    ...
    product = models.ManyToManyField(
        Product, related_name="network_product", verbose_name="Продукты"
    )
